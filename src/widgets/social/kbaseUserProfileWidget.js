define(['nunjucks', 'jquery', 'q', 'postal', 'kb.utils', 'kb.widget.social.base', 'kb.user_profile', 'kb.session', 'kb.widget.navbar', 'kb.logger'],
    function (nunjucks, $, Q, Postal, Utils, SocialWidget, UserProfile, Session, NAVBAR, Logger) {
        "use strict";
                    ...
                    return Q.Promise(function (resolve, reject) {
                        ...
                        if (!Session.isLoggedIn()) {
                            ...
                            this.userProfile.loadProfile()
                                ...
                                .catch(function (err) {
                                    Logger.logError('[UserProfile.sync] Error getting user profile.');
                                    Logger.logError(err);
                                    reject(err);
                                });
                        }
            ...
            renderInfoView: {
                value: function () {
                    ...
                    if (this.isOwner()) {
                        ...
                        // NB we don't clear the entire navbar -- it will still have
                        // the menu that is set by the view.
