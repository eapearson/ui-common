define(['kb.widget.dashboard.base', 'kb.runtime'], function (DashboardWidget, Runtime) {
        ...
        setInitialState: {
            value: function () {
                return Q.promise(function (resolve, reject, notify) {
                    Q.all([Q($.get(Runtime.config.getConfig('dashboard_metrics_url') + '/narrative_histogram.json')),
                        // Q($.get(Config.getConfig('dashboard_metrics_url') + '/narrative_shared_histogram.json')),
                        Q($.get(Runtime.config.getConfig('dashboard_metrics_url') + '/narrative_sharing_histogram.json')),
